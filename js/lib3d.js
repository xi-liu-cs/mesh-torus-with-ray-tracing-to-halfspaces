...
/*
const src = gl.getExtension('WEBGL_debug_shaders').getTranslatedShaderSource(program);
console.log(src);
*/
         ...
         if(aPos != -1)
         {
            ...
            gl.vertexAttribPointer(aPos , 3, gl.FLOAT, false, VERTEX_SIZE * bpe,  0);
         }

         let aNor = gl.getAttribLocation(program, 'aNor');  
         if(aNor != -1)
         {                    
