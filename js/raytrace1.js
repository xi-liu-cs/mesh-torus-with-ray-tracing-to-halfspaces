...
let comb_len = 3,
polyhedron_array = [], polyhedron_array2 = [], polyhedron_array3 = [], polyhedron_array4 = [],
combine_array = [];
...
make_polyhedron_array2(comb_len, polyhedron_array2, combine_array);
make_polyhedron_array3(comb_len, polyhedron_array3, combine_array);
make_polyhedron_array4(comb_len, polyhedron_array4, combine_array);
S.setUniform('4fv', 'u_polyhedron', polyhedron_array);
S.setUniform('4fv', 'u_polyhedron2', polyhedron_array2);
S.setUniform('4fv', 'u_polyhedron3', polyhedron_array3);
S.setUniform('4fv', 'u_polyhedron4', polyhedron_array4);
